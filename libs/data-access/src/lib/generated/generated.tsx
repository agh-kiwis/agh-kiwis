 ...
 * });
 */
export function useChunksQuery(
  baseOptions?: Apollo.QueryHookOptions<ChunksQuery, ChunksQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<ChunksQuery, ChunksQueryVariables>(
    ChunksDocument,
    options
  );
}
export function useChunksLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<ChunksQuery, ChunksQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<ChunksQuery, ChunksQueryVariables>(
    ChunksDocument,
    options
  );
}
...
export type ChunksQueryResult = Apollo.QueryResult<
  ChunksQuery,
  ChunksQueryVariables
>;
