...
export class AuthController {
  ...
  public async login(@Body() loginDto: AuthEmailLoginInput) {
    return this.service.login(loginDto, false);
  }

  @Post('admin/email/login')
  @HttpCode(HttpStatus.OK)
  public async adminLogin(@Body() loginDTO: AuthEmailLoginInput) {
    return this.service.login(loginDTO, true);
  }
